...
class WordPoints_Data_Type_Text extends WordPoints_Data_Type {
	...
	public function validate_value( $value ) {
		...
		if ( ! is_string( $value ) ) {
			return new WP_Error(); // TODO message
		}
...
//
//interface WordPoints_Data_Type_FormatI {
//	public function matches_format( $value );
//}
//
//class WordPoints_Data_Type_Format implements WordPoints_Data_Type_FormatI {
//
//	public function matches_format( $value ) {
//		return true
//	}
...
class WordPoints_Hook_Condition_Entity_Array_Contains extends WordPoints_Spec {
