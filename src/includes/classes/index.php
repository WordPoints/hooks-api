...
require_once( dirname( __FILE__ ) . 'entity/relationship/stored/db/table/conditionsi.php' );
require_once( dirname( __FILE__ ) . 'entity/relationship/stored/db/tablei.php' );
require_once( dirname( __FILE__ ) . 'entity/relationship/stored/field.php' );
require_once( dirname( __FILE__ ) . 'entity/relationship/stored/fieldi.php' );
