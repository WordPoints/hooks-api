...
/**
 * Test case for WordPoints_Hooks_API_Un_Installer.
 *
 ...
 * @since 1.0.0
 *
 * @covers WordPoints_Hooks_API_Un_Installer
 * @covers WordPoints_Legacy_Points_Hook_To_Reaction_Importer
 */
class WordPoints_Hooks_API_Un_Installer_Test extends WordPoints_PHPUnit_TestCase_Hooks {
		...
		return array(
			'registration' => array(
				...
				'import_settings' => array(
					...
					'reversals_legacy_points' => array( 'toggle_off' => 'toggle_on' ),
				),
			),
			'post' => array(
				'legacy_slug' => 'post',
	...
	/**
	 * Trigger installing the module.
	 *
	 * @since 1.0.0
	 */
	protected function install() {

		$installer = new WordPoints_Hooks_API_Un_Installer( 'hooks-api', '1.0.0' );
